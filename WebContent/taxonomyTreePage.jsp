...
<body>
	...
	<%
		...
		String[] arr1 = request.getParameterValues("checked1");

		String selectSensitiveHeader = "";

		for (int i = 0; i < arr1.length; i++) {

			if (i == arr1.length - 1) {

				selectSensitiveHeader += arr1[i];

				break;

			}

			selectSensitiveHeader += arr1[i] + delim;
		...
		System.out.println("selectSensitiveHeader : " + selectSensitiveHeader);
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item active"><a
					class="nav-link js-scroll-trigger">Taxonomy tree</a></li>
		...
		<div class="my-auto">
			...
			<div class="container" style="float: left; width: 40%">
				...
				<div class="subheading mb-1">
					...
					<%=selectSensitiveHeader.replaceAll(delim, ("   \t\t"))%>
			...
			<div class="container" style="float: right; width: 60%">
				...
				<form method="post" action="examplePage.jsp">
					...
					<input type="hidden" value="<%=delim%>" name="delimiter" /> <input
						...
						name="selectSensitiveHeader" /> <input type="hidden"
