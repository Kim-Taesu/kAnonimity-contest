...
<%
	...
	int maxSize = 1024 * 1024 * 1024 * 5; // 한번에 올릴 수 있는 파일 용량 : 10M로 제한
...
<body>
	...
	window.onload = function add_item(){
        ...
        <%request.setCharacterEncoding("UTF-8");
			...
			var strArr1 = str.split('<%=delim.toString()%>');
			...
			for (var i = 0; i < strArr1.length; i++) {
				...
				div1.setAttribute("value", strArr1[i]);

				div1.setAttribute("name", strArr1[i]);

				document.getElementById('cb1')
						.setAttribute("value", strArr1[i]);

				document.getElementById('cb1').setAttribute("name", "checked1");

				document.getElementById('label1').innerHTML = strArr1[i]
						.toUpperCase();

				div1.innerHTML = document.getElementById('dest1').innerHTML;
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top"
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link js-scroll-trigger">Download</a>
			</ul>
					...
					<div class="resume-content" style="width: 1000px; height: 200px">
						...
						<form method="post" action="taxonomyTreePage.jsp"
							...
							<div class="subheading mb-1">Select your header as a
								...
								sensitive-identifier</div>



							<div class="container" id="dest1" style="display: none;">

								<p style="float: left; margin: 10px;">

									<input type="checkbox" name="" value="" id="cb1"> <label
										id="label1" style="padding: 5px; vertical-align: middle;"></label>
							...
							<div>
								...
								<input type="hidden" value="<%=inputDataRealPath%>"
									...
									type="hidden" value="<%=delim%>" name="delimiter" />
